  ...
  return (
    <div className="space-y-2">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="max-w-[320px] min-w-0 sm:max-w-[40%]">
          <Chip tone="neutral" mode="wrap" className="max-w-full px-2 py-[2px] text-[10px]">
                  ...
                  <td className="px-3 py-2 text-right min-w-0">
                    <div className="flex justify-end min-w-0">
                      <Chip
                        ...
                        className={`max-w-full px-2 py-[2px] text-[10px] ${impactClass}`}
                      >
    ...
    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3 text-[11px] text-slate-600">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap items-center gap-2 text-[11px] min-w-0">
          ...
          <Chip tone="neutral" mode="wrap" className="max-w-full px-2 py-[2px] text-[10px]">
            Snapshot: {snapshotId ?? 'live data'}
          </Chip>
          <Chip tone="neutral" mode="wrap" className="max-w-full px-2 py-[2px] text-[10px]">
            {DATETIME_FORMATTER.format(generatedAt)}
          </Chip>
        </div>
      </div>
    </div>
    ...
    <div ref={ref} className="report-root text-slate-900 font-sans">
      ...
      <section className="pdf-page">
        <Section
          ...
          badge={
            showDrivers ? (
              <Chip tone="neutral" mode="wrap" className="px-3 py-1 text-xs">
                {movementBadge}
              </Chip>
            ) : undefined
          }
